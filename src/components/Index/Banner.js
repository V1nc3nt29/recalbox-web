                    ...
                    <div className="row">
                        <div className="col-lg-5 col-md-12">
                            <div className="main-banner-content">
                                ...
                                <ReactWOW delay='.1s' animation='fadeInLeft'>
                                    <p>La Recalbox vous permet de rejouer à une variété de consoles et de plateformes 
                                        dans votre salon, en toute simplicité ! Le système Recalbox OS est entièrement 
                                        libre et gratuit, et à été conçu spécialement pour que vous puissiez 
                                        créer la votre en un rien temps.</p>
                                </ReactWOW>
                                ...
                                <ReactWOW delay='.1s' animation='fadeInRight'>
                                    <div className="btn-box">
                                        ...
                                        >
                                            ...
                                            Télecharger Recalbox <span></span>
                                        </Link>
                                        ...
                                        >
                                            <i className="flaticon-google-play"></i> Monter sa Recalbox
                                        </Link>
                                    </div>
                                </ReactWOW>
                            </div>
